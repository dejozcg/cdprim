...
<style>
	...
	.fbp {
		...
		cursor: pointer;
		background-image: url("'. base_url() . 'theme/default/images/fbpresets/fbpresets.png");
    }';
...
echo '
	...
	echo '.fbpb-127281214508877{background-image: url("' . base_url() . 'theme/default/images/fbpresets/127281214508877.jpg");}';
	echo '.fbpb-1943057695973225{background-image: url("' . base_url() . 'theme/default/images/fbpresets/1943057695973225.jpg");}';
	echo '.fbpb-112865389425474{background-image: url("' . base_url() . 'theme/default/images/fbpresets/112865389425474.jpg");}';
	echo '.fbpb-126877221295325{background-image: url("' . base_url() . 'theme/default/images/fbpresets/126877221295325.jpg");}';
	echo '.fbpb-623911921148129{background-image: url("' . base_url() . 'theme/default/images/fbpresets/623911921148129.jpg");}';
	echo '.fbpb-1705020913127345{background-image: url("' . base_url() . 'theme/default/images/fbpresets/1705020913127345.jpg");}';
	echo '.fbpb-1200070923437550{background-image: url("' . base_url() . 'theme/default/images/fbpresets/1200070923437550.jpg");}';
	echo '.fbpb-357109954713249{background-image: url("' . base_url() . 'theme/default/images/fbpresets/357109954713249.jpg");}';
	echo '.fbpb-816008591908985{background-image: url("' . base_url() . 'theme/default/images/fbpresets/816008591908985.jpg");}';
	echo '.fbpb-425789167806189{background-image: url("' . base_url() . 'theme/default/images/fbpresets/425789167806189.jpg");}';
	echo '.fbpb-528808880819990{background-image: url("' . base_url() . 'theme/default/images/fbpresets/528808880819990.jpg");}';
	echo '.fbpb-308229619684986{background-image: url("' . base_url() . 'theme/default/images/fbpresets/308229619684986.jpg");}';
	echo '.fbpb-382422138883041{background-image: url("' . base_url() . 'theme/default/images/fbpresets/382422138883041.jpg");}';
	echo '.fbpb-396343990807392{background-image: url("' . base_url() . 'theme/default/images/fbpresets/396343990807392.jpg");}';
	echo '.fbpb-1974886472751579{background-image: url("' . base_url() . 'theme/default/images/fbpresets/1974886472751579.jpg");}';
